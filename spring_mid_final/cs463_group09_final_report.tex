...
\begin{center}
\begin{tabular}{ | C{1cm} | C{7cm}| C{6cm} | C{2cm} |} 
\hline
REQ\# & Requirement & What Happened To It & Comments \\ 
\hline
1 & Fix the "People" page where the list of people are shown from groups & Completed & blah\\ 
\hline
2 & Tweet at a person listed in database & Completed & blah\\ 
\hline
3 & Add user accounts to the application and track when a user has tweeted an event & Completed & blah\\ 
\hline
4 & List tweets about events and/or people via the app & Completed & blah\\ 
\hline
5 & List tweets about events and/or people from twitter, but not via the app & Completed & blah\\ 
\hline
6 & Export a list of people with information & Completed & blah\\ 
\hline
7 & Improve hashtag searching of application for better results on relevant events & Completed & blah\\ 
\hline
8 & Implement a system of finding events nearby a location entered or within radius of the user & Completed & blah\\ 
\hline
9 & Add feature to generate a profile for community developers to have contacting information easily visable & Completed & blah\\ 
\hline
10 & Improve the visuals of the tool and how it looks as a whole. & Completed & blah\\ 
\hline
\end{tabular}
\end{center}
