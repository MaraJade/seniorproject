...
\begin{enumerate}[label*=\arabic*.]
  \item Current Progress: We cannot currently track when a user tweets from our
    ...
    Code Snippet 3, the website makes a call to Twitter's search API, requesting
...
\begin{enumerate}[label*=\arabic*.]
  \item Current Progress: The website now has a tweet parser. As shown in Code
    Snippet 4, it sends a call to Twitter's search API, requesting all tweets
